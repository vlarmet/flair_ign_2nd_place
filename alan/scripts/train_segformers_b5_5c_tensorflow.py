...
val_img_paths = []
for dep in os.listdir("flair-one/data/val"):
...
model2 = TFSegformerForSemanticSegmentation.from_pretrained(
    "nvidia/mit-b5", # seletecd size of pretrained segformer model b0,b1,b2,b3,b4,b5
    num_labels=13
)
...
checkpoint = "models/segformer_b5_5c/segformer" #@param {type:"string"}
