...
# model.load_state_dict(torch.load("models/mask2former-swin-large-ade-semantic/mask2former-swin-large-ade-semantic"))
...
for epoch in range(2):
  ...
  for idx, batch in enumerate(tqdm(train_dataloader)):
      ...
      if step % 5000 == 0:
          ...
          torch.save(model.state_dict(), 'models/mask2former-swin-large-ade-semantic/mask2former-swin-large-ade-semantic')