...
def effnet_v2_b0(x, model = None, weights = "imagenet", indices = None):
    if model is None:
...
def effnet_v2_b1(x, model = None, weights = "imagenet", indices = None):
    if model is None:
...
def effnet_v2_b2(x, model = None,weights = "imagenet", indices = None):
    if model is None:
...
def effnet_v2_b3(x, model=None,weights = "imagenet", indices = None):
    if model is None:
...
def effnet_v2_s(x, model=None,weights = "imagenet", indices = None):
    if model is None:
...
def effnet_v2_m(x, model=None,weights = "imagenet", indices = None):
    if model is None:
...
def effnet_v2_l(x, model=None,weights = "imagenet", indices = None):
    if model is None:
